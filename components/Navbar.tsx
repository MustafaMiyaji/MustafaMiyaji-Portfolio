  ...
  return (
    <>
        ...
        <motion.div 
            ...
            transition={{ delay: 1 }}
            className="fixed top-6 right-6 z-[900] flex items-center gap-3 md:gap-4"
        >
            <div className="hidden xs:flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-100/50 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-white/10 text-[10px] font-mono text-slate-600 dark:text-cyan-400 shadow-sm">
                <Clock size={12} />
                <span>{time}</span>
            </div>
            ...
            <button 
                ...
                className="p-2 rounded-full bg-slate-100/50 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white transition-colors shadow-sm"
            ...
            <button 
                ...
                className="flex items-center gap-2 px-3 py-2 rounded-full bg-slate-100/50 dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 hover:text-cyan-600 dark:hover:text-white transition-colors shadow-sm"
        ...
        className="fixed bottom-6 md:bottom-8 left-1/2 -translate-x-1/2 z-[999] pointer-events-auto max-w-[95vw]"
        >
        <div className="flex items-center gap-1 md:gap-2 p-1.5 md:p-2 rounded-full bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200 dark:border-white/10 shadow-2xl shadow-cyan-500/10 dark:ring-1 dark:ring-white/5">
            {navItems.map((item) => {
            ...
            return (
                ...
                whileTap={{ scale: 0.95 }}
                className={`relative group p-2 md:p-3 rounded-full transition-all duration-300 overflow-hidden ${
                    isActive 
            ...
            <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="relative group p-2 md:p-3 rounded-full text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-white/5 transition-all duration-300"
            >
                <Search size={18} />
            </motion.button>
